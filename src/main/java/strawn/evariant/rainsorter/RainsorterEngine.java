...
public class RainsorterEngine {
     ...
     * 
     * @return Completed RainsorterEngine
     ...
     */
    public static RainsorterEngine createEngine() throws InvalidDataException, IOException {
        return new RainsorterEngine(
     ...
     * @throws InvalidDataException Thrown if a precipitation record cannot be matched to a station, or if an MSA region definition cannot be mapped to an MSA
     */
